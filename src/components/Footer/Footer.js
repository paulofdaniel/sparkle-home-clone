            ...
            <div className="container-md">
                <div className="row">
                    ...
                    <div className="col-12 col-lg-4">
                        <h2>Sparkle</h2>
                        <ul className="footer__links">
                            <li><a href="#">Conteúdos em alta</a></li>
                        </ul>
                    </div>
                </div>
                <div className="row">
